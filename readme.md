...
If you want to use `4.0.x` branch of Refinery with Rails 5.1.x. Install using this template:

    rails new app_name -m http://refinerycms.com/t/4.0.0

If you want to use `3.0.x` branch of Refinery with Rails 4.2.x. Install using this template:
